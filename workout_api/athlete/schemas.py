...
from workout_api.team.schemas import CentroTreinamentoAtleta
...
class Athlete(BaseSchema):
    ...
    category: Annotated[str, Field(description='category of Athlete', examples={'live weight'}, max_length=20)]
